---
title: "Git的一些使用说明"
date: 2025-08-23T17:21:04+07:00
draft: false
weight: 670
summary: "🎯 项目白皮书 此文档，主要的受众是 Git 的中高阶使用者 ## 一、高频实用命令 🔼 🔽 ### 1、👀查看@当前仓库 🔼 🔽 ### 2、👀查看@所有子模块一起看（含嵌套） 🔼 🔽 ### 3、👀查看@针对某个子模块目录 🔼 🔽 ### 4、修改 🔼 🔽 ## 二、进阶使用必修 🔼 🔽 ### 1、什么是变基（rebase） 🔼 🔽 变基（rebase"
