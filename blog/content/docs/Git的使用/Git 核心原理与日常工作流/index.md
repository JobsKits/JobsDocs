---
title: "Git 核心原理与日常工作流"
date: 2026-08-04T15:56:10+08:00
draft: false
weight: 200
summary: "## 🔥 前言 > Git 的命令不是对“同一份代码”做不同操作，而是在工作区、索引、对象库和引用之间移动内容或指针。先知道命令影响哪一层，再决定怎样提交、整合、撤销和恢复。 ## 一、对象、快照与引用 🔼 🔽 ### 1.1、四类核心对象 | 对象 | 保存什么 | 关键事实 | | --- | --- | --- | | blob | 文件内容 | 不直"
